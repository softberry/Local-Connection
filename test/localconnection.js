...
var LocalConnection = /*#__PURE__*/function () {
  ...
  _createClass(LocalConnection, [{
    ...
    */
    ...
    value: function isConnected() {
      ...
      for (var itemIndex = 0; itemIndex < self.frames.length; itemIndex++) {
    ...
    value: function getFrameByName(frame) {
      ...
      function deeperFrame(objectFrame, frame) {
        ...
        while (d < objectFrame.length) {
          var deepFrame = objectFrame.frames[d];
          d++;
